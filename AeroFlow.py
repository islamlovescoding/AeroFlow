...
def register_props():
    ...
    bpy.types.Scene.drag_velocity = bpy.props.FloatProperty(
        name="Velocity",
        default=10.0
    )

    bpy.types.Scene.drag_coefficient = bpy.props.FloatProperty(
        name="Cd",
        default=1.0
    )

classes = [
    OBJECT_OT_calculate_drag,
    VIEW3D_PT_drag_panel,
]
